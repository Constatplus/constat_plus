...
class StepBeforeWorksCadastral extends StatefulWidget {
  ...
  @override
  State<StepBeforeWorksCadastral> createState() =>
      _StepBeforeWorksCadastralState();
}
...
class _StepBeforeWorksCadastralState extends State<StepBeforeWorksCadastral> {
  ...
  Widget build(BuildContext context) {
    return ListView(
      children: [
        const Text(
          'Document cadastral et personnes présentes',
          style: TextStyle(fontSize: 30, fontWeight: FontWeight.w900),
        ),
        const SizedBox(height: 8),
        const Text(
          'Sélectionnez le document utile et renseignez les personnes présentes lors de la visite.',
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              for (var i = 0; i < _persons.length; i++) ...[
                Row(
                  children: [
                    Expanded(
                      child: TextField(
                        controller: _persons[i],
                        decoration: InputDecoration(
                          labelText: 'Nom, qualité et partie représentée',
              ...
              OutlinedButton.icon(
                onPressed: () =>
                    setState(() => _persons.add(TextEditingController())),
