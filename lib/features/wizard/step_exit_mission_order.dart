...
class _StepExitMissionOrderState extends State<StepExitMissionOrder> {
  ...
  final TextEditingController _ownerRepresentativeController =
      TextEditingController();
  final TextEditingController _tenantRepresentativeController =
      TextEditingController();
  final TextEditingController _missionScopeController = TextEditingController(
    text:
        'Réaliser contradictoirement l’état des lieux de sortie, relever les observations, les clés, les index et les entretiens, établir le procès-verbal, chiffrer les dégâts locatifs et proposer une indemnité compensatoire.',
  );
          ...
          child: Column(
            ...
            children: [
              Wrap(
                ...
                children: [
                  FilledButton.icon(
                    onPressed: _takeMissionPhoto,
                    icon: const Icon(Icons.camera_alt_outlined),
                    label: const Text('Prendre une photo'),
                  ),
                  OutlinedButton.icon(
                    onPressed: _chooseMissionPhoto,
                    icon: const Icon(Icons.photo_library_outlined),
                    label: const Text('Choisir une photo'),
                  ),
                  if (_missionPhoto != null)
                    TextButton.icon(
                      onPressed: () => setState(() => _missionPhoto = null),
          ...
          child: Column(
            children: [
              CheckboxListTile(
                ...
                value: _ownerSelected,
                onChanged: (v) => setState(() => _ownerSelected = v ?? false),
                title: const Text('Bailleur'),
                subtitle: TextField(
                  controller: _ownerController,
                  decoration: _input('Nom du bailleur'),
                ),
              ),
              CheckboxListTile(
                contentPadding: EdgeInsets.zero,
                value: _tenantSelected,
                onChanged: (v) => setState(() => _tenantSelected = v ?? false),
                title: const Text('Preneur / locataire'),
                subtitle: TextField(
                  controller: _tenantController,
                  decoration: _input('Nom du preneur'),
                ),
              ),
              CheckboxListTile(
                contentPadding: EdgeInsets.zero,
                value: _ownerRepresentative,
                onChanged: (v) =>
                    setState(() => _ownerRepresentative = v ?? false),
                title: const Text('Représentant du bailleur'),
                subtitle: TextField(
                  controller: _ownerRepresentativeController,
                  decoration: _input('Nom et qualité'),
                ),
              ),
              CheckboxListTile(
                contentPadding: EdgeInsets.zero,
                value: _tenantRepresentative,
                onChanged: (v) =>
                    setState(() => _tenantRepresentative = v ?? false),
                title: const Text('Représentant du preneur'),
                subtitle: TextField(
                  controller: _tenantRepresentativeController,
                  decoration: _input('Nom et qualité'),
                ),
              ),
              CheckboxListTile(
                contentPadding: EdgeInsets.zero,
                value: _expertSelected,
                onChanged: (v) => setState(() => _expertSelected = v ?? false),
                title: const Text('Expert désigné par les parties'),
              ),
            ],
          ),
        ),
            ...
            children: [
              SizedBox(
                ...
                child: DropdownButtonFormField<String>(
                  ...
                  items:
                      const ['Chaque partie', 'Bailleur', 'Preneur / locataire']
                          .map(
              ...
              SizedBox(
                ...
                child: TextField(
                  ...
                  decoration: _input('Prix convenu (€ TVAC)'),
                ),
              ),
            ],
          ),
        ...
        _section(
          ...
          child: Column(
            ...
            children: [
              ...
              TextField(
                controller: _missionScopeController,
                minLines: 3,
                maxLines: 7,
                decoration: _input(
                  'Fonctions complémentaires / étendue particulière de la mission',
                ),
              ),
            ],
          ),
